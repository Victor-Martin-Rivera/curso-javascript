...
document.addEventListener('DOMContentLoaded', () => {
    ...
    mostrarAutos(autos) // Muestra los uatos al cargar
...
function mostrarAutos(autos) {
    limpiarHTML() // Elimina el HTML previo al filtrar
...
function filtrarAuto(){
    // Se usa una Función de alto nivel
...
// Función que muestra un mensaje si no hay resultados encontrados
function noResultado(){
    ...
    noResultado.textContent = 'No Hay Resultados, Selecciona otra Opción'

    resultado.append(noResultado)
}

// Como tenemos una función se pasa un parametro para cada uno
